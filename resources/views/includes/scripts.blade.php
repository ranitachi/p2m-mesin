<script type="text/javascript" src="{{asset('build/js/vendor/jquery/jquery.min.js')}}"></script>
        ...
        <script type="text/javascript" src="{{asset('build/js/vendor/jvectormap/jquery-jvectormap.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('build/js/vendor/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
        <script type="text/javascript" src="{{asset('build/js/vendor/jvectormap/jquery-jvectormap-us-aea-en.js')}}"></script>
        
        <script type="text/javascript" src="{{asset('build/js/vendor/rickshaw/d3.v3.js')}}"></script>
        <script type="text/javascript" src="{{asset('build/js/vendor/rickshaw/rickshaw.min.js')}}"></script>
