                                                    ...
                                                    @foreach ($direktur as $key=>$item)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{url('direktur/'.$item->id)}}" class="btn btn-xs btn-info btn-rounded" data-toggle="tooltip" title="Edit Data"><i class="fa fa-edit" ></i></a> 
