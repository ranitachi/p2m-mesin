...
@section('title')
    <title>Data Direktur :: P2M Departemen Teknik Mesin FT-UI</title> 
@endsection
@section('konten')
    <div class="app-heading app-heading-bordered app-heading-page">
                    ...
                    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><a href="{{url('direktur')}}">       </a></li>                                                     
                            <li class="active"><a href="#">Form {{$id==-1 ? 'Tambah' : 'Edit'}} Direktur</a></li>                                                     
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block block-condensed">
                                    <div class="app-heading">                                        
                                        <div class="title">
                                            <h2>Form {{$id==-1 ? 'Tambah' : 'Edit'}} Direktur</h2>
                                            <!-- <p>Quick information</p> -->
                                        </div>              
                                        <div class="heading-elements">
                                            <a href="{{url('direktur')}}" class="btn btn-xs btn-primary"><i class="fa fa fa-arrow-left"></i>&nbsp;Data Direktur</a>
                                        </div>
                                    </div>
                                    <div class="block-content">
                                    <form id="formDirektur" class="form-horizontal" method="POST" action="{{$id==-1 ? url('direktur') : url('direktur/'.$id) }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" name="nip" id="kode" class="form-control" value="{{$id==-1 ? '' : $det->nip}}" placeholder="Kode NIP">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Nama</label>
                                                        <div class="col-md-8">
                                                            <input type="text" name="nama" id="nama" class="form-control" value="{{$id==-1 ? '' : $det->nama}}" placeholder="Nama Direktur">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
<script>
    $(document).ready(function(){
        $('#btnSimpan').on('click',function(){
            ...
            {
                var ps='<h3><i class="fa fa-exclamation-circle"></i>&nbsp;&nbsp;Error</h3>Nama Direktur Harus Diisi';
                pesanNoty(ps,'error');
                $('#nama').focus();
            }
