...
@section('konten')
    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Data Instruktur</a></li>                                                     
                                ...
                                <div class="block block-condensed">
                                    <div class="app-heading">                                        
                                        ...
                                        <div class="heading-elements">
                                            <a href="{{url('instruktur/-1')}}" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Tambah Data</a>
                                        </div>
                                    </div>
...
<script>
    ...
    function hapus(id)
    {
        ...
        $('#submit-primary').on('click',function(){
            location.href='{{url("instruktur-hapus")}}/'+id;
        });
    }
</script>
@endsection