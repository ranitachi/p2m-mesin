...
@section('konten')
    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Data Riwayat Pelatihan Peserta</a></li>                                                     
                                ...
                                <div class="block block-condensed">
                                    <div class="app-heading">                                        
                                        ...
                                        <div class="heading-elements">
                                            <a href="{{url('peserta')}}" class="btn btn-xs btn-primary"><i class="fa fa-chevron-left"></i>&nbsp;Kembali Ke Data Peserta</a>
                                                    ...
                                                    @if ($pelatihan->count()!=0)
                                                        ...
                                                        @foreach ($pelatihan as $item)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @foreach ($instruktur as $v)
                                                                        <b>[{{$v->instruktur->inisial}}]</b> : {{$v->instruktur->nama}}<br>
                                                                    @endforeach
                                                                </td>
                                                            </tr>
                                                            @php
