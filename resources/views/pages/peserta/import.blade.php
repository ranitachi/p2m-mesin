...
@section('konten')
    <div class="app-heading-container app-heading-bordered bottom">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><a href="#">Import Data Peserta</a></li>                                                     
                                ...
                                <div class="block block-condensed">
                                    <div class="app-heading">                                        
                                        ...
                                        <div class="heading-elements">
                                            <a href="{{url('peserta')}}" class="btn btn-xs btn-primary"><i class="fa fa-caret-left"></i>&nbsp;Kembali</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="block-content">
                                        <form id="formPeserta" class="form-horizontal" method="POST" action="{{url('UploadFilePeserta')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <small><a href="{{URL::to('format-excel-peserta')}}">* Unduh Contoh File &nbsp;<i class="fa fa-download"></i></a></small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
